                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a href="action.php">Pencegahan</a></li>
                              <li><a class="active" href="news.php">Tentang</a></li>
                           </ul>
            ...
            <div class="row d_flex grid">
               <div class="col-md-7">
                  <div class="coronata_img text_align_center">
                     <figure><img src="images/vaksin.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-5 oder1">
                  <div class="titlepage text_align_left">
                     <h2>Apa itu vaksin? </h2>
                     <p>Vaksin adalah bagian dari virus yang sudah dilemahkan atau tak mampu menyebarkan penyakit yang kemudian disuntikan ke tubuh,“Vaksin Covid-19 ini manfaatnya adalah sebagai pelatih untuk tubuh kita agar bisa mengenali virus yang membahayakan tersebut.” 
                     </p>
                  </div>
               </div>
            </div>
